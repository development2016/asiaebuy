                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($value2['approver'] == 'level') { ?>
                                                            ...
                                                            <ol>
                                                            <?php foreach ($value2['approval'] as $key3 => $value3) { ?>
                                                                <li>
                                                                <?php echo $value3['approval'];?>

                                                                    <?php if ($value2['approver_level'] == $value3['approval']) { ?>

                                                                       : <label class="label bg-blue-steel div-request-pulsate">Waiting To Approve</label>

                                                                    <?php } else { ?>

                                                                        <?php if ($value3['status'] == 'Approve') { ?>

                                                                        : <label class="label bg-green-jungle font-dark">Approve</label>
                                                                            
                                                                        <?php } else { ?>

                                                                        : <label class="label bg-yellow-saffron font-dark">Pending</label>
                                                        ...
                                                        <?php } elseif ($value2['approver'] == 'normal') { ?>
