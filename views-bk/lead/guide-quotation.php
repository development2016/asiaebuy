            ...
            <div class="invoice-content-2 bordered">
                        ...
                        <h4>
                            ...
                            <span class="pull-right">
                                <?php if (empty($list[0]['sellers'][0]['shipping'])) { ?>
                                    ...
                                    <?= Html::a('-',FALSE, ['value'=>Url::to([
                                    'information/guide-shipping-create',
                                ...
                                <?php } elseif ($list[0]['sellers'][0]['shipping'] == 'No') { ?>
                                    ...
                                    <?= Html::a('-',FALSE, ['value'=>Url::to([
                                    'information/guide-shipping-update',
                                    'project'=>(string)$list[0]['_id'],
                                    'seller'=>$seller,
                                    'path' => 'lead'
                                    ]),'class'=>'shipping']); ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?= Html::a($showShipping = number_format((float)$list[0]['sellers'][0]['shipping_price'],2,'.',','),FALSE, ['value'=>Url::to([
                                    'information/guide-shipping-update',
                                    'project'=>(string)$list[0]['_id'],
                                    'seller'=>$seller,
                                    'path' => 'lead'
                                    ]),'class'=>'shipping']); ?>
                                    <?php $shipping = $list[0]['sellers'][0]['shipping_price']; ?>
                        ...
                        <h4>
                            ...
                            <span class="pull-right">
                                <?php if (empty($list[0]['sellers'][0]['install'])) { ?>
                                    ...
                                    <?= Html::a('-',FALSE, ['value'=>Url::to([
                                    'information/guide-installation-create',
                                    'project'=>(string)$list[0]['_id'],
                                    'seller'=>$seller,
                                    'path' => 'lead'
                                    ]),'class'=>'installation']); ?>
                                ...
                                <?php } elseif ($list[0]['sellers'][0]['install'] == 'No') { ?>
                                    ...
                                    <?= Html::a('-',FALSE, ['value'=>Url::to([
                                    'information/guide-installation-update',
                                    'project'=>(string)$list[0]['_id'],
                                    'seller'=>$seller,
                                    'path' => 'lead'
                                    ]),'class'=>'installation']); ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?= Html::a($showInstall = number_format((float)$list[0]['sellers'][0]['installation_price'],2,'.',','),FALSE, ['value'=>Url::to([
                                    'information/guide-installation-update',
                                    'project'=>(string)$list[0]['_id'],
                                    'seller'=>$seller,
                                    'path' => 'lead'
                                    ]),'class'=>'installation']); ?>
                                    <?php $install = $list[0]['sellers'][0]['installation_price']; ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?= Html::a('Submit', [
                        'generate/generate-guide-quotation',
                        'seller'=>$seller,
