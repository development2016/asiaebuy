...
class InformationController extends Controller
{
    ...
    public function actionAddDelivery($project,$seller,$buyer,$path)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($path == 'spot') {
                ...
                return $this->redirect(['source/spot-purchase-requisition','project'=>(string)$project,'seller'=>$seller,'buyer'=>$buyer]);
           
            } elseif ($path == 'sale') {

                 return $this->redirect(['source/sale-purchase-requisition','project'=>(string)$project,'seller'=>$seller,'buyer'=>$buyer]);

            } elseif ($path == 'guide') {

                 return $this->redirect(['source/guide-purchase-requisition','project'=>(string)$project,'seller'=>$seller,'buyer'=>$buyer]);
               
            } elseif ($path == 'direct') {

                 return $this->redirect(['source/direct-purchase-requisition','project'=>(string)$project,'seller'=>$seller,'buyer'=>$buyer]);
